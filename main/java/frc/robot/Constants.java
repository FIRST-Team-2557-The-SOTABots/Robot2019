...
public class Constants {
	...
	// //real bot !!!
	public static double multparm = 197; // ** ?? //
	...
	public static double armForCargo = 6600; //6600
	public static double armIntake = 4550; //4550
	...
	public static double climbRetract3 = -13000; // ** ?? //
	public static double climbRetract2 = -4000;
	public static int climb3 = 3;
	public static int climb2 = 2;
	public static int climb03 = 0;
	public static int climb02 = 1;
